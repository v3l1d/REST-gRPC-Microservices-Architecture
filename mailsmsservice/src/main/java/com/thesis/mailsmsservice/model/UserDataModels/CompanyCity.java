...
public class CompanyCity {
    ...
    public CompanyCity withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CompanyCity withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public CompanyCity withValue(boolean value) {
        this.value = value;
        return this;
    }
    ...
    public CompanyCity withBelfioreCode(String belfioreCode) {
        this.belfioreCode = belfioreCode;
        return this;
    }
    ...
    public CompanyCity withProvinceCode(String provinceCode) {
        this.provinceCode = provinceCode;
        return this;
    }
    ...
    public CompanyCity withBancaItaliaCode(Object bancaItaliaCode) {
        this.bancaItaliaCode = bancaItaliaCode;
        return this;
    }
    ...
    public CompanyCity withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
